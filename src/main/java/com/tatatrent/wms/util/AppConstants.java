...
public interface AppConstants {
	...
	String INSERT_HEADER_SQL = String.format("INSERT INTO %s (TRANSID, RSYSTEMID, ORDERKEY, EXTERNORDERKEY, STORERKEY, ORDERDATE, DELIVERYDATE, REQUESTEDSHIPDATE, PRIORITY, TYPE, CONSIGNEEKEY, BUYERPO, SUSR1, SUSR2, SUSR3, SUSR4, SUSR5) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", HEADER_TABLE);
